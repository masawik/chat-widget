...
function Header({isCollapsed, toggleChat, online, isConnecting, isError, reconnect, togglePin, isPinned, draggable}) {
  ...
  return (
    <div className={`${styles.container}`}>
      <div
        className={`${draggable} ${styles.contentArea}`}
        style={isPinned ? null : {'cursor': 'all-scroll'}}
      >{$content}</div>
