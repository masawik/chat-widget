...
function MessageForm({onAdd, onError, reqStatus, replyPurpose, replyProcessed}) {
  ...
  return (
    <Fragment>
      <OptionsPanel open={isSettingsOpen}/>
      ...
      />
        ...
        <div className={styles.buttonsBox}>
          <button
            ...
            disabled={isLoading}
          >
            <svg className={settingsBtnIconStyles} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <button
            ...
            disabled={isLoading}
          >
            <svg className={styles.sendBtnIcon} viewBox="0 0 448.011 448.011" xmlns="http://www.w3.org/2000/svg">
              <path
